# Generated by Django 5.2.4 on 2026-05-31 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('open', 'Открыт'), ('closed', 'Закрыт')], default='open', max_length=6, verbose_name='Состояние')),
                ...
                ('skills', models.ManyToManyField(blank=True, related_name='projects', to='projects.skill', verbose_name='Требуемые навыки')),
            ],
            options={
                'verbose_name': 'Проект',
